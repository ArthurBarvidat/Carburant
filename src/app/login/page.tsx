...
export default function LoginPage() {
  ...
  useEffect(() => {
    setIsApp(typeof window !== 'undefined' && !!(window as unknown as Record<string, unknown>).Capacitor)
  }, [])
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Boutons sociaux — masqués dans l'app (Google bloque OAuth dans WebView) */}
        {!isApp && (
        ...
        {/* Message info dans l'app */}
        {isApp && (
          <div style={{ marginBottom: '20px', padding: '12px 14px', borderRadius: '12px', background: 'rgba(168,85,247,.08)', border: '1px solid rgba(168,85,247,.2)', color: '#94a3b8', fontSize: '13px', textAlign: 'center', lineHeight: 1.5 }}>
            📱 Dans l&apos;app, connecte-toi avec ton <strong style={{ color: '#c084fc' }}>email et mot de passe</strong>.<br />
            <span style={{ fontSize: '11px' }}>La connexion Google est disponible sur le site web.</span>
          </div>
        )}
